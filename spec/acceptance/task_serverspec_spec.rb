...
describe 'test_tool=serverspec' do
  it 'without params, fails to run' do
    ...
    task_result = run_task('test::role', task_params)
  ...
  it 'installs serverspec gem' do
    ...
    run_task('test::role', task_params)
    cmd_result = run_command('ls /tmp/puppet_test/serverspec/gems/serverspec*/serverspec.gemspec')
